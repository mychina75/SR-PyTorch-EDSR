...
class DRLN(nn.Module):
    def __init__(self, args):
        ...
        self.sub_mean = ops.MeanShift((0.4542, 0.4609, 0.4557), sub=True)
        self.add_mean = ops.MeanShift((0.4542, 0.4609, 0.4557), sub=False)
        ...
        self.csa = CSAM_Module(chs)
        self.c28 = ops.BasicBlock(chs, chs, 3, 1, 1)

        self.b21 = Block(chs * 7, chs)
        self.c29 = ops.BasicBlock(chs * 7, chs, 3, 1, 1)
    ...
    def forward(self, x):
        ...
        cat_layer = torch.cat([o3.unsqueeze(1), o6.unsqueeze(1), o9.unsqueeze(1), o12.unsqueeze(1),
                               o16.unsqueeze(1), o20.unsqueeze(1)], dim=1)
