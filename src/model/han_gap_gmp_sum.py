...
class CALayer(nn.Module):
    def __init__(self, channel, reduction=16):
        ...
        self.c5 = ops.BasicBlock(channel, (channel // reduction) * 3, 1, 1, 0, 1)
        ...
        self.c10 = ops.BasicBlockSig((channel // reduction)*3*2, channel, 1, 1, 0)
    ...
    def forward(self, x):
        ...
        #y3 = c1.view(m_batchsize, 1, (C // self.reduction) * 3, 1)
        #y4 = c5.view(m_batchsize, 1, (C // self.reduction) * 3, 1)

        c_out = torch.cat([c1, c5], dim=1)
        #c9 = self.c9(c_out)

        #y5 = c9.view(m_batchsize, (C // self.reduction) * 3, 1, 1)
        y = self.c10(c_out)
